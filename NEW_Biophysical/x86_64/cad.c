...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cad /Users/yjkimnada/CA1_Sim/Biophysical/x86_64/cad.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/yjkimnada/CA1_Sim/Biophysical/cad.mod";
static const char* nmodl_file_text = 
  ...
  ":    mmol / (dm3 * ms) = -10000 * mA / (cm2 * C * um) \n"
  ":    mmol / (dm3 * ms) = -10000 * mC / (cm2 * C * um * s) \n"
  ":    1000 * mol / (dm3 * s * 1000) = -10000 * C / (cm2 * C * um * s * 1000) \n"
  ":    mol / (dm3 * s) = -10 / (cm2 * um * s) \n"
  ":    mol / (dm3 * s) = -10 * 100 / (dm2 * um * s) \n"
  ":    mol / (dm3 * s) = -10 * 100 * 100000 / (dm2 * dm * s) \n"
  ":    mol / (dm3 * s) = - 10000 * 10000 / (dm3 * s) - I don't understand the 10000 factor! \n"
  "    \n"
  "    \n"
