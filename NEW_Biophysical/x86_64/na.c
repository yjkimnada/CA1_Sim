...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na /Users/yjkimnada/CA1_Sim/Biophysical/x86_64/na.mod\n");
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 101 in file na.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/yjkimnada/CA1_Sim/Biophysical/na.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
  "\n"
  ...
  ": 30 pS/um2 = 0.003 S/cm2 = 3 mS/cm2\n"
  "\n"
  "PARAMETER {\n"
  "	gbar = 1000   	(pS/um2)	: 0.12 mho/cm2; \n"
  "	vshift = -5	(mV)		: -10 voltage shift (affects all)\n"
  "								\n"
