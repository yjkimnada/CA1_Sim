...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kv /Users/yjkimnada/CA1_Sim/Biophysical/x86_64/kv.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 78 in file kv.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/yjkimnada/CA1_Sim/Biophysical/kv.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
  ...
  ": 1 pS/um2 = 1000 e-12 S/um2 = 1e-9 S/ 1e-8 cm2 = 1e-1 S/cm2 = 1e-4 mho/cm2\n"
  "\n"
  "PARAMETER {\n"
